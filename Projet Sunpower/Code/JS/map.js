function init() {
  ...
  marker.bindPopup("<style> h5 {font-weight:bold;}</style>Vous trouverez 5 bornes de recharge ici </br><img src='../Assets/Gare.jpg'</br><h5>Gare de Montpellier Saint Roch</h5><h6>Pl. Auguste Gibert, 34000 Montpellier</h6>");
  var marker = L.marker([43.637496, 3.873805], { icon: redIcon }).addTo(map);
  marker.bindPopup("Vous trouverez 5 bornes de recharge ici </br><img src='../Assets/zoo.jpg'</br><h6>1000 Av. du Val de Montferrand, 34000 Montpellier</h6> ");
  var marker = L.marker([43.584750, 3.955913], { icon: redIcon }).addTo(map);
  marker.bindPopup("<style> h5 {font-weight:bold;}</style>Vous trouverez 5 bornes de recharge ici</br><img src='../Assets/aeroport.jpg'</br> <h5>Aéroport de Montpellier</h5><h6>D172, 34130 Mauguio</h6>");
  var marker = L.marker([43.602692, 3.921461], { icon: redIcon }).addTo(map);
  marker.bindPopup("<style> h5 {font-weight:bold;}</style>Vous trouverez 5 bornes de recharge ici</br><img src='../Assets/odiceum.jpg'</br> <h5> Odysséum</h5><h6>2 Pl. de Lisbonne, 34000 Montpellier</h6>");
